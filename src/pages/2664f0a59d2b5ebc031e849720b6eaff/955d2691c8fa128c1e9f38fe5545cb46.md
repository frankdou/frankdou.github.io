...
interface Events {
    onAction: ((callback: () => void) => void) | undefined
}

// Intersection Type: Requires both 'name' AND 'age'
type Person = HasName & HasAge & Events

const user: Person = {
  name: "Alice",
  age: 30,
  // An object must satisfy *both* interfaces
}
```
